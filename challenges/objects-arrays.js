...
const universities = graduates.map(person => person.university);
universities.sort();
...
const uni = [];
let uniFilter = graduates.forEach(function(person){
...
let nameHabitat = zooAnimals.forEach(function (animal) {
  animalNames.push(`Name: ${animal.animal_name}, Scientific: ${animal.scientific_name}`)
});
// zooAnimals.map(animal => `Name: ${animal.animal_name}, Scientific: ${animal.scientific_name}`)
